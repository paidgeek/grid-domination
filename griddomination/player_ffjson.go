...
// source: ./griddomination/player.go
// DO NOT EDIT!
...
var ffj_key_Player_SessionToken = []byte("session_token")

var ffj_key_Player_Score = []byte("score")

var ffj_key_Player_Pixels = []byte("pixels")
	...
	for {
		...
		case fflib.FFParse_want_key:
			...
			if len(kn) <= 0 {
				...
				case 'p':
					...
					if bytes.Equal(ffj_key_Player_Pixels, kn) {
						currentKey = ffj_t_Player_Pixels
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 's':
					...
					if bytes.Equal(ffj_key_Player_SessionToken, kn) {
						currentKey = ffj_t_Player_SessionToken
						state = fflib.FFParse_want_colon
						goto mainparse

					} else if bytes.Equal(ffj_key_Player_Score, kn) {
				...
				if fflib.EqualFoldRight(ffj_key_Player_Pixels, kn) {
					currentKey = ffj_t_Player_Pixels
					state = fflib.FFParse_want_colon
					goto mainparse
				}
				...
				if fflib.EqualFoldRight(ffj_key_Player_SessionToken, kn) {
					currentKey = ffj_t_Player_SessionToken
					state = fflib.FFParse_want_colon
					goto mainparse
				}
		...
		case fflib.FFParse_want_value:
			...
			if tok == fflib.FFTok_left_brace || tok == fflib.FFTok_left_bracket || tok == fflib.FFTok_integer || tok == fflib.FFTok_double || tok == fflib.FFTok_string || tok == fflib.FFTok_bool || tok == fflib.FFTok_null {
				...
				case ffj_t_Player_SessionToken:
					goto handle_SessionToken

				case ffj_t_Player_Score:
					goto handle_Score

				case ffj_t_Player_Pixels:
					goto handle_Pixels
